...
nruns = 4 # how many runs do you want to do? Keep at 1 until you know what you're doing.


fresh_start = False # if True: starts the fit from scratch. if False: picks up where the fit left off.
perform_error = True # if True: does a long error estimation. Don't set to True until your fit has converged and you're satisfied with it.
...
## Read in the data ##
input_filename = '/home/david/work/meats/SEDs/reextractions/wasp-107/hasp_output/hst_15694_stis_wasp-107_g140m_odzb_cspec.fits'
data = fits.getdata(input_filename, 1)[0]
wave_to_fit = data['WAVELENGTH']
flux_to_fit = data['FLUX']
error_to_fit = data['ERROR']#*np.sqrt(2)
...
fit_mask = (wave_to_fit >= 1213.5) & (wave_to_fit <= 1218.0)
...
cont_mask = (wave_to_fit > 1208.) & (wave_to_fit < 1212) | (wave_to_fit > 1220.) & (wave_to_fit < 1224)
...
if mask_data:
    mask = (wave_to_fit >= 1215.2) & (wave_to_fit <=1215.8) # example wavelength to mask
...
lsf_filename = '/home/david/work/filters/stis/LSF_G140M_1200.txt'
...
variables[p]['min'] = -50  # minimum of the parameter range
variables[p]['max'] = 50 # maximum of the parameter range
...
variables[p]['min'] = 17.0
variables[p]['max'] = 19.5
...
if perform_error:
    ...
    filename="wasp-107_SR_MCMC_results.csv"  # EDIT ME FOR EACH FIT!
