...
path = '/home/david/work/meats/SEDs/draft_hlsp/toi-134/'  #path where the files are

star = 'TOI-134'
version = 1
airglow =  [1207, 1222, 1300, 1310, 1353, 1356]

trims = {'G430L':[3146, 5690], 'G230L':[1700, 3145 ]}
...
def make_sed(path, star, version, norm=False, remove_negs=False, to_1A=False, sed_type='var'):
    ...
    proxy_path = '/media/david/2tb_ext_hd/hddata/mega_muscles/v26_hlsp_fixed/GJ649/hlsp_muscles_hst_stis_gj649_g140l_v25_component-spec.fits'
    d_prox = 10.39
    d_star = 25.18
    scale = (d_prox/d_star)**2
    sed_table, instrument_list = sed.add_proxy(sed_table, proxy_path, instrument_list, scale, ranges = [1364, 1699], remove_negs=remove_negs,to_1A=to_1A)
