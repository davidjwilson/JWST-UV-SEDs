...
path = '/home/david/work/meats/SEDs/draft_hlsp/k2-141/'  #path where the files are

star = 'K2-141'
version = 1
airglow =  [1214, 1217, 1300, 1310, 1353, 1356]

trims = {'G230L':[1715, 3162], 'G140L':[1160, 1715], 'G430L':[3163, 5690]}
...
def make_sed(path, star, version, norm=False, remove_negs=False, to_1A=False, sed_type='var'):
    ...
    sed_table, instrument_list, gap = sed.add_xray_spectrum(sed_table, path, instrument_list, 'xmm', add_apec = True, find_gap=True, to_1A=to_1A, trims=trims, remove_negs=remove_negs)
